      ...
      >
        ...
        <div className="space-y-4 text-sm sm:text-base text-left">
          ...
          <ul className="list-disc list-inside space-y-1 text-blue-100">
            <li>Interacted with Arbitrum between <strong className="text-yellow-300">Apr 11, 2024 – Apr 11, 2025</strong></li>
            <li>Snapshot: <strong className="text-yellow-300">Apr 11, 2025 – 00:00 AM UTC</strong></li>
            <li>Eligibility is <strong className="text-yellow-300">not automatic, you must register your wallet</strong></li>
            <li>Ends after <strong className="text-yellow-300">3 days</strong></li>
          </ul>
        ...
        {!isConnected && !agreed && (
          <p className="text-center text-yellow-400">Please agree to the terms to proceed.</p>
        )}
        ...
        {isConnected && (
          <div className="text-center space-y-4">
            ...
            <button
              onClick={() => disconnect()}
              className="px-4 py-2 bg-blue-700 hover:bg-blue-800 rounded-lg font-semibold text-white"
            >
              Disconnect
            </button>
